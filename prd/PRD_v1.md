...
2. **Annotations** — types & fields (FR-01/02/03), records & listing (FR-04/05/06).
...
See `catalogs/open-questions.md`. **All 10 resolved (2026-07-22):** OQ-01 personas (cross-functional
teams); OQ-02 activation/usage KPIs; OQ-03 options on field definition; OQ-04 single-membership flat
groups; OQ-05 dates by min/max; OQ-06 inline Card; OQ-07 i18n (preference→header→English, admin-edited,
en/pt fixed); OQ-08 stateless JWT; OQ-09 validation baseline; OQ-10 NFR targets. No open questions block v1.
