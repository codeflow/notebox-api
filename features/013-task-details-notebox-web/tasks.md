...
- [ ] **T-01 · Wire foundation — types with structural guards, view-model send rules and echo builders, date formatter, MSW fixtures**
...
- [ ] **T-02 · Card and dates on the list and the task form — `CardLink`, `CardFields`, `TasksTable` columns, `TaskForm` card fields + routing**
...
- [ ] **T-03 · Subtasks panel — Card column, editor card inputs, routing, formatted date cells, span footer, tick echoes card**
...
- [ ] **T-04 · Details tab — `useRichImageUpload` extraction, `TaskDetailsTab` view + inline edit with the shipped rich-text stack**
...
- [ ] **T-05 · Detail page assembly + integration suite + live pass — metrics rows, Card panel, tabs, page-level scenarios**
