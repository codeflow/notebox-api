...
| FR-02 | Type field declares name, field type ∈ closed set of 7, optional icon, "visible for viewing" flag with per-type defaults. | Must | INTAKE C4,C6–C12,K3,D2 + BR-04 | US-1.1 | todo |
...
| FR-05 | List a type's annotations returning visible fields; detail view returns all fields incl. non-visible. | Must | INTAKE C14,C18 + BR-09 | US-2.2 | todo |
