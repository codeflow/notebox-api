...
| ID | User Story | FR/BR | Status | Feature |
|----|------------|-------|--------|---------|
| US-3.1 | As a tenant member, I want to group annotations and tasks and get a navigation tree, so I can organize my workspace. | FR-08, FR-09 | building | feat-014-groups-navigation-notebox-api (api, issue #15) — **merged into `develop` 2026-08-24** (PR #16, squash `043859a`; audit Round 1 pass w/ findings, F-01..F-03 + N-01 all closed; spec amended to v2; 369 tests; branch + PR CI green) · feat-015-groups-navigation-notebox-web (notebox-web, issue #14) — **spec approved 2026-08-24** (26 scenarios), plan pending · feat-016-group-counts (api, issue #17) — **audit Round 1 PASS with findings 2026-08-24, F-01/F-02 closed same day** (0 blockers; 389 tests; F-03 backlogged — the statement-budget scenario has no executable test), on `feature/group-counts`, publish + PR pending. **Sequenced before feat-015** (pipeline reordered 2026-08-24): feat-015's `implement` consumes these fields |
